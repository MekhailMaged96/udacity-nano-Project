...
# Create admin user which is Mekhail Maged
User1 = User(name="Mekhai Maged", email="mekhailmaged45@gmail.com",
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     ...
                     ", linguine-shaped rice noodles called banh pho0,"
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake",
                     ...
                     "milk and topped with vanilla bean"
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     ...
                     "and seasoned with a spicy mix(chilli, tamarind"
                     "among others)"
